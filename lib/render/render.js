import { LLM_CHATBOTS, WIDGET_SETTINGS_CONFIG } from "../constants.js";
      ...
      h(
        ...
        Object.keys(WIDGET_SETTINGS_CONFIG).map((key) => {
          ...
          return h(
            ...
            h("label", { htmlFor: `setting-${key}` }, config.label),
            h("input", {
              type: "text",
              id: `setting-${key}`,
    ...
    return h(
      ...
      h(
        ...
        h("input", {
          ...
          placeholder: "Enter GitHub PAT to access private repos",
