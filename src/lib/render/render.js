...
export class Renderer {
  ...
  #renderWidgetHeader() {
    ...
    return h(
      ...
      h("span", {}, this.stateManager.getTitle()),
      h("span", {}, isCollapsed ? iconChevronUp() : iconChevronDown())
    );
  }
  ...
  #renderInputArea() {
    ...
    return h(
      "div",
      { className: "input-area" + (showAttachments ? " large" : "") },
          ...
          chatHistory.map((chat) => {
            ...
            return h(
              ...
              h(
                "button",
                {
                  ...
                  title: `Restore chat from ${date}${
                    chat.postKey ? ` (from ${chat.postKey})` : ""
                  }`,
                },
              ...
              h(
                "button",
                {
                  className: "clear delete-button",
                  onClick: (e) => {
                    e.stopPropagation();
                    this.eventsHandler.handleClickDeleteChat(chat);
                  },
                  disabled: isLoading,
